...
class cifar_dataset(Dataset): 
    def __init__(self, dataset, r, noise_mode, root_dir, transform, mode, noise_file='', pred=[], probability=[], log=''): 
        ...
        noise_file = os.path.join(root_dir, 'noise_file', noise_mode + '_' + str(r) + '_' + str(raw_seed))
...
class cifar_dataloader():  
    def __init__(self, dataset, noise_ratio, noise_mode, batch_size, num_workers, root_dir, model, seed, log='', noise_file=''):
